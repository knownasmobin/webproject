...
func (ur *categoryRepository) GetCategoryById(ctx context.Context, id uint64) (*domain.Category, error) {
	span := tooty.OpenAnAPMSpan(ctx, "[R] get category by id", "repository")
	defer tooty.CloseTheAPMSpan(span)
