module git.ecobin.ir/ecomicro/template

go 1.19

require (
	git.ecobin.ir/ecomicro/bootstrap v0.0.0-20230206115217-a15d251835f0
	git.ecobin.ir/ecomicro/tooty v0.0.0-20230206114351-0a7806ebb13a
	git.ecobin.ir/ecomicro/transport v0.0.0-20230110125533-38979b490009
	git.ecobin.ir/ecomicro/x v0.0.0-20230125094223-d7ce62e0ca26
